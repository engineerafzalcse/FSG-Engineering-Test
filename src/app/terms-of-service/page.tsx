  ...
  return (
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        {/* Assessment scope */}
        <section>
          <h2 className='text-foreground mb-3 text-xl font-semibold'>Assessment Scope</h2>
          <p className='text-muted-foreground text-base leading-relaxed'>
            WorkTrack is provided as a technical assessment project. Its interfaces, sample data,
            and workflows are intended for evaluation and demonstration rather than production use.
          </p>
        </section>
